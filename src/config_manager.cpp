...
SchemaConfig SchemaConfig::get_default() {
    ...
    config.mappings = {
        ...
        {"estimated_num_employees", {"First Current Company Size", "Company Size", "organization.employeesOnLinkedin", "company_employee_count"}},
        {"first_name", {"First Name", "firstName", "first_name"}},
        {"headline", {"Headline", "headline"}},
        {"id", {"_id"}},
        {"index", {"_index"}},
        {"industry", {"First Current Company Industry", "Company Industry", "organization.industry", "company_industry"}},
